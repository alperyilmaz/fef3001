...
**İçerik**: Veri türleri ve verilerin işlenmesine dair bilgi verildi. Performans ölçütleri konusuna başlandı. [Sunum linki1](ders3_1.qmd) ve [Sunum link2](ders3.qmd)
...
**İçerik**: Yapay sinir ağları [Sunum linki](ders7.qmd). 

## Ders8

*28 Kasım Perşembe 16:00*

**İçerik**: Sınıflandırma [Sunum linki](ders8-classification.qmd). 

## Ders9

*5 Aralık Perşembe 16:00*

**İçerik**: Sınıflandırma devam [Sunum linki](ders8-classification.qmd). 
...
**İçerik**: Regresyon [Sunum linki](ders10-regression.qmd). 

## Ders11

*19 Aralılk Perşembe 16:00*

**İçerik**: Kümeleme [Sunum linki](ders11-clustering.qmd). 

## Ders12

*2 Ocak Perşembe 16:00*

**İçerik**: Doğal Dil İşleme, NLP [Sunum linki](ders12-nlp.qmd). 22 Mayıs'ta yapılan dersin toplantı kaydı için [tıklayınız](https://yildiz-edu-tr.zoom.us/rec/play/ZWGyqhHk-URfERAiSx-WXQtAxMdAHXyBoBingLhVMY2F2c68xOOIRqfOcGc6kfUBceNxnkfZmkq_m_o-.fNUW9LJfs_ksoUr4)
